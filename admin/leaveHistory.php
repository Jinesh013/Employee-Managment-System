        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Employees Leave History</h1>
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody id="tableData">
                                ...
                                <tr>
                                    ...
                                    <td style="width:16%;"><?php echo $row['LeaveResons'];?></td>
                                    ...
                                    ?>
                                    <td>
                                        <p style="color:blue"><?php echo $row['LeaveStatus'];?></p>
                                    </td>
                                    <?php
                                    }
                                    else if($row['LeaveStatus'] == 'Accept')
                                    {
                                        ?>
                                    <td>
                                        <p style="color:green"><?php echo $row['LeaveStatus'];?></p>
                                    </td>
                                    <?php
                                    }
                                    else
