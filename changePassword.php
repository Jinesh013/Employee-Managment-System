...
if(isset($_POST['submit']))
  {        
        ...
        $query = "SELECT * FROM employeemaster WHERE EmpUsername='$username'";
        
        $result = mysqli_query($con, $query);
        $rows = mysqli_fetch_array($result);
        
        if($password!= $rows['EmpPassword'])
        {
        ...
        else
        {
            ...
            {
                $query = "UPDATE employeemaster SET EmpPassword='$newpassword' where EmpUsername='$username'";
