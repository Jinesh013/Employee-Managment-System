        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">My Leave History</h1>
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <?php
                                        ...
                                        // echo $username;
                                        $query1 = "SELECT * FROM leavetable where EmpUsername= '$username' ";
                                ...
                                <tr>
                                    ...
                                    <?php
                                    if ($row['LeaveStatus']== 'Accept'){
                                        ?>
                                        <td><p style="color:green"><?php echo $row['LeaveStatus'];?></p></td>
                                        <?php
                                    }
                                    else if($row['LeaveStatus']== 'Reject')
                                    {
                                        ?>
                                        <td><p style="color:red"><?php echo $row['LeaveStatus'];?></p></td>
                                        <?php 
                                    }
                                    else
                                    {
